...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query(value = "select distinct customer from Customer customer left join fetch customer.customers",
    ...
    @Query("select customer from Customer customer left join fetch customer.customers where customer.id =:id")
